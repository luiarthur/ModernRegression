...
that the errors are indeed approximately normal. So the normal assumption was met. 
...
times in the 1000 iterations were selected into the final model. (See Figure.1)
\begin{figure}
\begin{center}
<<fig=T,echo=FALSE>>=
  my.plot()
